  ...
  return (
    <div className={`flex flex-col gap-2.5 ${compact ? '' : 'mt-1'}`}>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-full inline-flex items-center justify-center gap-2.5 px-5 py-3 rounded-pill font-mono text-xs tracking-widest uppercase font-semibold transition-all text-white active:scale-[0.98] hover:opacity-90"
